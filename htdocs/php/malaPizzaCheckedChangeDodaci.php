        ...
        <div class="row menu-item py-3">
            <div class="col-md-12">
                <div class="form-check">
                    <input class="form-check-input" name="dodaci" type="checkbox" value="' . $red['CenaMala'] . '" id="' . $red['NazivProizvoda'] . '" onchange="calculateTotalPrice()">
                    <label class="form-check-label" for="' . $red['NazivProizvoda'] . '">
                    ' . $red['NazivProizvoda'] . '
                    </label>
                    <p class="float-end" id="cenaDodatka"> ' . $red['CenaMala'] . ',00</p>
                </div>
            </div>
        </div>
        ';
