...
<html lang="en">
  <head>
    ...
    <meta name="description" content="O la la Labudovo brdo je restoran brze hrane sa preko petnaest godina dugom tradicijom, dođite i uverite se zašto smo omiljeni među komšijama.">
    <meta name="keywords" content="o la la, olala, o la la labudovo brdo, o la la picerija, o la la palacinkarnica">
    <!-- Bootstrap CSS -->
    ...
    <title>Labudovo brdo - O la la</title>
...
<script>
  ...
  <body onload="chooseImage()">
    <div class="container-fluid section-1-wrapper">
        <div class="row">
            <div class="col-md-12 px-0">
                <a href="index.php"><img id="coverImage" width="100%" height="100%" src="images/logoLabudovoBrdo.webp" class="img-fluid mx-auto d-block"></a>
            </div>
        </div>
    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body">
                                ...
                                <?php
                                    $upitDodaciZaPizze = "select * from jelovniklabudovobrdo where VrstaProizvoda = 'DODACI ZA PICU'";
                                    ...
                                    while(($red = $rez->fetch_assoc())){
                                        ...
                                        <div class="row menu-item py-3">
                                            <div class="col-md-12">
                                                ...
                                                <p class="float-end">' . $red['CenaMala'] . ',00; ' . $red['CenaSrednja'] . ',00; ' . $red['CenaVelika'] . ',00</p>
                                            </div>
                                        </div>
                                        ';
                                    }
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                            ...
                            <div class="accordion-body">
                                ...
                                <?php
                                    $upitDodaciZaPalacinke = "select * from jelovniklabudovobrdo where VrstaProizvoda = 'DODACI ZA SLATKU PALACINKU'";
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                            ...
                            <?php
                                ...
                                <?php
                                    $upitDodaciZaSlanePalacinke = "select * from jelovniklabudovobrdo where VrstaProizvoda = 'DODACI ZA SLANU PALACINKU'";
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseEleven" class="accordion-collapse collapse" aria-labelledby="headingEleven"
                            ...
                            <?php
                                ...
                                <div class="row menu-item py-3">
                                    <div class="col-md-12 d-flex justify-content-center align-items-center">
                                        <p style="font-size:1.2em"><b>DODACI ZA POHOVANU PALAČINKU</b></p>
                                    </div>
                                </div>
                                <?php
                                    $upitDodaciZaPohovanePalacinke = "select * from jelovniklabudovobrdo where VrstaProizvoda = 'DODACI ZA SLANU PALACINKU'";
                                    $rez = $mysqli->query($upitDodaciZaPohovanePalacinke);
                                    while(($red = $rez->fetch_assoc())){
                                        echo '
                                        <div class="row menu-item py-3">
                                            <div class="col-md-12">
    ...
    <?php include 'php/labudovoInfoBeli.php' ?>
    ...
    <script>
        function chooseImage(){
            if(screen.width > 768){
                document.getElementById("coverImage").setAttribute("src", "images/logoLabudovoBrdoVeliki.webp");
            }
        }
    </script>        
